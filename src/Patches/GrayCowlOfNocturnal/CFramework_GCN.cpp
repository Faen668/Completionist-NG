...
namespace CPatch_GCN {
	...
	inline std::string_view modname = "Gray Fox Cowl.esm";
	...
	void CHandler::InjectAndCompileData() {
		...
		//RegisterAs<FrameworkID::kGCN_Items>(&Items_NameArray, &Items_FormArray, &Items_BoolArray, &Items_TextArray);
		//RegisterAs<FrameworkID::kGCN_Books>(&Books_NameArray, &Books_FormArray, &Books_BoolArray, &Books_TextArray);
		//RegisterAs<FrameworkID::kGCN_MapMa>(&MapMa_NameArray, &MapMa_FormArray, &MapMa_BoolArray, &MapMa_TextArray);
	}
