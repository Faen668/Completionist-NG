...
namespace CPatch_FSK_Items {
	Serialization::CompletionistData Data;
}

namespace CPatch_FSK_Books {
	Serialization::CompletionistData Data;
}

namespace CPatch_FSK_MapMa {
	Serialization::CompletionistData Data;
}
...
namespace CPatch_FSK {
	...
	inline std::string_view modname = "Falskaar.esm";
	...
	void CHandler::InjectAndCompileData() {
		...
		//RegisterAs<FrameworkID::kFSK_Items>(&Items_NameArray, &Items_FormArray, &Items_BoolArray, &Items_TextArray);
		//RegisterAs<FrameworkID::kFSK_Books>(&Books_NameArray, &Books_FormArray, &Books_BoolArray, &Books_TextArray);
		//RegisterAs<FrameworkID::kFSK_MapMa>(&MapMa_NameArray, &MapMa_FormArray, &MapMa_BoolArray, &MapMa_TextArray);
	}
