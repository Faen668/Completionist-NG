	...
	void CHandler::ProcessFoundForm(RE::FormID a_baseID, RE::FormID a_eventID, std::string a_variable) {
		...
		if (a_variable == "CPatch_FOS_ItmL1") {
			...
			if (!FoundItemData.HasForm(a_eventID)) {
				...
				FrameworkAPI::AddNewEventToLog(Serialization::CompletionistLog::kCollected, CPatch_FOS_ItmL1::Data.GetForm(a_eventID)->GetName());
			}
		...
		if (a_variable == "CPatch_FOS_ItmL2") {
			...
			if (!FoundItemData.HasForm(a_eventID)) {
				...
				FrameworkAPI::SendNotification(msg, "NotifyItems");
				FrameworkAPI::AddNewEventToLog(Serialization::CompletionistLog::kCollected, CPatch_FOS_ItmL2::Data.GetForm(a_eventID)->GetName());
			}
		...
		if (a_variable == "CPatch_FOS_ItmL3") {
			...
			if (!FoundItemData.HasForm(a_eventID)) {
				...
				FrameworkAPI::SendNotification(msg, "NotifyItems");
				FrameworkAPI::AddNewEventToLog(Serialization::CompletionistLog::kCollected, CPatch_FOS_ItmL3::Data.GetForm(a_eventID)->GetName());
			}
